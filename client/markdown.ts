 ...
 * hypothetical — `amitkaps/base`'s own content docs already used all three and rendered garbled
 ...
 * (unlike `amitkaps/base`'s own `docs.ts`, which needs a fresh instance per doc for
