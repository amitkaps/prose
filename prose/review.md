...
| 3.1–3.3 | New *since* view (vs `HEAD`, a ref, or the last explicit **Mark reviewed**) answers "what changed"; staleness is secondary, uses `blame -w` + ignore-revs, and its limits are stated | spec §1, §5.2, §6.5; plan step 4 |
...
| Framing | Prose is code review without a PR: §1 maps each part of a PR review to its counterpart here | spec §1 |
